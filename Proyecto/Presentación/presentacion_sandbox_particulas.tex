...
\begin{frame}{Problema computacional}
    ...
    Aunque CPU y CUDA mantienen complejidad $O(N^2)$, la GPU puede repartir el trabajo entre miles de hebras.
\end{frame}
...
\end{verbatim}
    ...
    \begin{itemize}
        ...
        \item No usa hebras ni paralelismo explícito.
        \item Aumentar $N$ impacta muy fuerte en FPS.
    \end{itemize}
\end{frame}

\begin{frame}[fragile]{CUDA tiled}
    En CUDA, cada hebra procesa una partícula:
...
\end{verbatim}
    ...
    \begin{itemize}
        ...
        \item Cada hebra escribe solamente su propia partícula.
...
\begin{frame}{Metodología de medición}
    ...
    \begin{itemize}
        \item CPU: Intel Core i5-11400F, 6 núcleos / 12 hebras.
