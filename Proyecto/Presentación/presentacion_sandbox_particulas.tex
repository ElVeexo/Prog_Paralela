...
\begin{frame}{Metodología de medición}
    \begin{itemize}
        \item Se midió el frame completo, no solo el kernel.
        \item Incluye simulación, construcción de datos visuales, copia y render OpenGL.
        \item Se usaron 10 muestras por ejecutable y por tamaño $N$.
        \item El benchmark recompila cada caso con el valor de partículas correspondiente.
    \end{itemize}
    ...
    \begin{center}
        ...
        \fbox{
            \begin{minipage}[c][5.0cm][c]{0.82\textwidth}
                \centering
                Video de ejecución del sandbox con $N = 8192$ partículas\\[0.25cm]
                CPU secuencial vs CUDA
            \end{minipage}
        }
